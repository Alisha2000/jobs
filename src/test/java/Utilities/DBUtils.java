...
public class DBUtils {
    ...
    public static void establishConnection(DBType dbType) throws SQLException {
        if(dbType.equals(DBType.ORACLE)){
            connection= DriverManager.getConnection(Configuration.getProperty("DBURLORACLE"),
            ...
            connection= DriverManager.getConnection(Configuration.getProperty("DBURLMySQL"),
            Configuration.getProperty("MySQLUsername"),
            Configuration.getProperty("MySQLPassword"));
            statement=connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
